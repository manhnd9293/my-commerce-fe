...
function ProductColorForm({onAddColor, initialColors, onUpdateColor, onDeleteColor}: ProductColorFormProps) {
  ...
  return (
    <div>
      ...
      <div className={'mt-4'}>
        <Table>
          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell className={'text-center'} colSpan={3}>No color data</TableCell>
            </TableRow>
            }
          </TableBody>
        </Table>
      ...
      <AlertDialog open={openDeleteConfirmDialog}
          ...
          <AlertDialogHeader>
            <AlertDialogTitle>
              <div className={'flex gap-2 items-center flex-wrap'}>
                ...
                <div
                  style={{backgroundColor: initialColors[deleteIndex]?.code}} className={cn('size-4 rounded')}></div>
              </div>
            </AlertDialogTitle>
            <AlertDialogDescription>
